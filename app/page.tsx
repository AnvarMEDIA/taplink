...
const products = ["Трубы", "Арматура", "Швеллер", "Уголок", "Профиль", "Лист", "Балка", "Фасонные"];

// Primary CTAs — rendered as big buttons
const cta = [
  {
...
// Secondary links — rendered as cards
const links = [
  {
...
const socials = [
  {
    href: "https://t.me/metalcity_uz", label: "Telegram",
  ...
  {
    href: "https://www.instagram.com/metalcity_uz/", label: "Instagram",
  ...
  {
    href: "https://wa.me/998950810000", label: "WhatsApp",
  ...
  {
    href: "https://metalcity.uz", label: "Сайт",
  ...
  {
    href: "https://play.google.com/store/apps/details?id=uz.bdmgroup.metalcity", label: "Google Play",
    icon: <svg width="17" height="17" viewBox="0 0 24 24" fill="currentColor"><path d="M3.18 23.76c.3.17.64.24.99.2l12.6-7.27-2.72-2.72-10.87 9.79zM.54 1.1C.2 1.42 0 1.96 0 2.67v18.67c0 .71.2 1.25.54 1.57l.08.08 10.46-10.46v-.25L.62 1.03l-.08.07zm20.1 9.1l-2.98-1.72-3.04 3.04 3.04 3.04 3-1.73c.86-.49.86-1.3-.02-1.63zM4.17.24l12.6 7.27-2.72 2.72L3.18.44C3.48.27 3.87.08 4.17.24z"/></svg>,
  },
];
// ─────────────────────────────────────────────
      ...
      <div className="relative z-10 flex flex-col items-center min-h-screen px-4 pt-8 pb-12">
        <div className="w-full max-w-[390px] space-y-3">
          ...
          <div className="space-y-2.5">
            {links.map((link, i) => (
              <LinkCard key={link.href} {...link} delay={i + 7} />
            ))}
          </div>
